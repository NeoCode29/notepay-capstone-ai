...
# Gambar crop disimpan di subfolder per kelas: OCR_DATASET_DIR/<class_name>/crop_XXXXX.jpg
...
MAX_LABEL_LEN = 80                    # panjang label maksimum yang didukung

CRNN_EPOCHS     = 60
CRNN_BATCH_SIZE = 16   # mixed_float16 — hemat 50% VRAM, aman di 4GB dengan input 32×512
CRNN_LR         = 1e-3
VAL_SPLIT       = 0.15

# ---------------------------------------------------------------------------
# Expense Classifier — Fase 5
# ---------------------------------------------------------------------------
CLASSIFIER_MODEL_DIR  = os.path.join(MODELS_DIR, "classifier")
CLASSIFIER_MODEL_PATH = os.path.join(CLASSIFIER_MODEL_DIR, "classifier_model.keras")

# 7 kategori pengeluaran umum struk minimarket Indonesia
EXPENSE_CATEGORIES = [
    "Makanan & Minuman",       # 0
...
CLASSIFIER_VOCAB_SIZE  = 5000
CLASSIFIER_EMBED_DIM   = 64
CLASSIFIER_SEQ_LEN     = 20    # panjang maksimum token per item
